                    ...
                    <div className="text-center mb-16" data-oid="8r.1vsv">
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-gray-400" data-oid="_cm2c9a">
                                    code
                                </span>
                            </h1>
                                ...
                                >
                                    <div className="flex items-center space-x-3" data-oid="bz6zrzy">
                                        <div
                                            ...
                                            data-oid="mpobfxb"
                                        ></div>
                                        <span className="text-white font-medium" data-oid=":4x4c8o">
                                            My Figma Project
                                        </span>
                                    </div>
                                    <button
                                ...
                                >
                                    ...
                                    <div className="space-y-2" data-oid="0rlte67">
                                        ...
                                        <div
                                            ...
                                            data-oid="zoybvid"
                                        >
                                            <div className="text-blue-400" data-oid="vj-782g">
                                                import React from 'react';
                                            </div>
                                            <div className="text-purple-400" data-oid="fogom-t">
                                                const Component = () =&gt; {'{'}
                                            </div>
                                            <div className="text-gray-300 ml-4" data-oid="akls48t">
                                                return (
                                            </div>
                                            <div
                                            ...
                                            <div className="text-gray-500 ml-12" data-oid="pz14o0z">
                                                ...
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="max-w-7xl mx-auto" data-oid="z4hax7w">
                    ...
                    >
                        <div data-oid="ey178-i">
                            ...
                            <div className="text-gray-400" data-oid="1md6h_p">
                                Designs Converted
                            </div>
                        </div>
                        <div data-oid="hn_t2g5">
                            ...
                            <div className="text-gray-400" data-oid="glfk3gm">
                                Happy Developers
                            </div>
                        </div>
                        <div data-oid="8c-o1d8">
                            ...
                            <div className="text-gray-400" data-oid="jurt_4q">
                                Code Accuracy
                            </div>
                        </div>
                        <div data-oid="d1aord4">
                            ...
                            <div className="text-gray-400" data-oid="q3pr:9k">
                                AI Support
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto" data-oid="a1o:.u4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8" data-oid="u_ycfkl">
                        ...
                        <div data-oid="9e4jd60">
                            <h4 className="font-semibold mb-4" data-oid="6nfrpk9">
                                Product
                            </h4>
                        ...
                        <div data-oid="q_kz5gf">
                            <h4 className="font-semibold mb-4" data-oid="p:hxzjx">
                                Resources
                            </h4>
                        ...
                        <div data-oid="ojbdan3">
                            <h4 className="font-semibold mb-4" data-oid="sj.komz">
                                Company
                            </h4>
